...
const EducationItem = (props) => {
    ...
    return <div className="EducationItem">
        <div className="CollegeName"><strong>College Name: </strong><span>{education.title}</span></div>
        <div className="Course"><strong>Course: </strong><span>{education.degree}</span></div>
        <div className="PassingYear"><strong>Passing Year: </strong><span>{education.date}</span></div>
    </div>
}
